...
--
-- Dumping data for table `patientlabreport`
--

LOCK TABLES `patientlabreport` WRITE;
/*!40000 ALTER TABLE `patientlabreport` DISABLE KEYS */;
INSERT INTO `patientlabreport` VALUES (1,'Mcg','Good',3,1),(2,'ML','Midium',2,2),(3,'ML','Midium',1,3);
/*!40000 ALTER TABLE `patientlabreport` ENABLE KEYS */;
UNLOCK TABLES;
