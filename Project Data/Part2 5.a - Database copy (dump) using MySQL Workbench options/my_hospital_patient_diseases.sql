...
CREATE TABLE `patient_diseases` (
  ...
  KEY `fk_patient_diseases_diseases1_idx` (`diseases_Diseases_id`),
  CONSTRAINT `fk_patient_diseases_diseases1` FOREIGN KEY (`diseases_Diseases_id`) REFERENCES `diseases` (`Diseases_id`),
  CONSTRAINT `fk_patient_diseases_patient_register1` FOREIGN KEY (`patient_register_iPatient_regester_id`) REFERENCES `patient_register` (`iPatient_regester_id`)
